...
export class CreateComponent implements OnInit {
  ...
  constructor(public vocabuService: VocabuService,private router: Router) { }
  ...
  submit(){
    console.log(this.form.value);this.vocabuService.create(this.form.value).subscribe(res => {
