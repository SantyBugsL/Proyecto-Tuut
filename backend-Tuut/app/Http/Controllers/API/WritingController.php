...
class WritingController extends Controller
{
    ...
    public function getAll(){$data = Writing::get();
      ...
      public function delete($id){$res = Writing::find($id)->delete();
        return response()->json([
      ...
      public function get($id){$data = Writing::find($id);
        return response()->json($data, 200);
      }
